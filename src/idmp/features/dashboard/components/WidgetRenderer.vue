...
.db-chart-card { display:flex; flex-direction:column; padding:16px 18px 12px; } .db-chart-card :deep(.idmp-chart-frame) { flex:1 1 auto; min-height:0; } .dashboard-chart-table { width:100%; border-collapse:collapse; font-size:12px; } .dashboard-chart-table th,.dashboard-chart-table td { padding:8px 10px; border-bottom:1px solid var(--idmp-border-soft,#eaecf0); text-align:right; } .dashboard-chart-table th:first-child,.dashboard-chart-table td:first-child { text-align:left; }
